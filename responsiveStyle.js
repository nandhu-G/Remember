...
const noticeItems = [
    ...
    "IT IS STILL RUNNING...!",
    window.screen.height*1.5 || window.innerHeight+200 || document.documentElement.clientHeight+200,
    window.screen.width*1.5 || window.innerWidth+200 || document.documentElement.clientWidth+200,
